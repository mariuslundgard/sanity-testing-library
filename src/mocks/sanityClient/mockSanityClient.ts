...
/** @alpha */
export interface MockSanityClientTransactionLog {
  id: number
  commit: any[][]
  create: any[][]
...
/** @alpha */
export interface MockSanityClientLog {
  ...
  dataRequest: any[]
  request: any[]
  transaction: MockSanityClientTransactionLog[]
}

/** @alpha */
export type MockSanityClient = SanityClient & {
  $log: MockSanityClientLog
}
...
export function createMockSanityClient(
  ...
  const mockClient = {
    ...
    dataRequest: (endpoint: string, body: any, _options: any = {}) => {
      $log.dataRequest.push({endpoint, body, options: _options})
  ...
  // TODO: fix this
  return mockClient as unknown as MockSanityClient

  function _createTransaction({observable}: {observable: boolean}) {
    const id = ++transactionId

    const $txLog: MockSanityClientTransactionLog = {
      id,
      commit: [],
      create: [],
      createIfNotExists: [],
